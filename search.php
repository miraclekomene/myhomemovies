    ...
    <div class="row">
        ...
        if($channel =="movie"){
            foreach($search->results as $results){
                ...
                echo '<a href="movie.php?id=' .$id.'"class="col-11 col-md-5 pt-2 col-lg-2 m-3" style="text-decoration: none; color: black;"><div class="card h-100" style=" box-shadow: 0px 5px 15px 5px black"><img src="'.$backdrop.'"alt="No Image" style="width: 100%;">
            ...
            foreach($search->results as $results){
                ...
                echo '<a href="tvshow.php?id=' .$id. '"class="col-11 col-md-5 pt-2 col-lg-2 m-3" style="text-decoration: none; color: black;"><div class="card h-100" style="box-shadow: 0px 5px 15px 5px black"><img src="'.$backdrop.'"alt="No Image" style="width: 100%;">
